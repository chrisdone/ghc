...
getInitialKind cusk
    (ClassDecl { tcdLName = L _ name, tcdTyVars = ktvs, tcdATs = ats })
...
getInitialKind cusk (SynDecl { tcdLName = L _ name
                             , tcdTyVars = ktvs
                             , tcdRhs = rhs })
...
getInitialKind _ (DataDecl _ (L _ _) _ _ (XHsDataDefn _)) = panic "getInitialKind"
